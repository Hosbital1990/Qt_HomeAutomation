...
struct qt_meta_stringdata_CLASSPlayBackENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSPlayBackENDCLASS = QtMocHelpers::stringData(
    "PlayBack",
    "startPlayBack",
    ""
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSPlayBackENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject PlayBack::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSPlayBackENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSPlayBackENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSPlayBackENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *PlayBack::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSPlayBackENDCLASS.stringdata0))
